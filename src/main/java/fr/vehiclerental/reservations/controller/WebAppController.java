...
public class WebAppController {
    ...
    public ResponseEntity<Map<String, Object>> addReservations(@Validated @RequestBody RequiredReservation informations) {
        ClientDTO client = reservationsService.clientVerification(informations);
        reservationsService.canReserve(client.getBirthday(), client.getNumberLicense());
        reservationsService.clientHaveAReservation(client.getId(), reservationsDao);
        VehicleDTO vehicle = reservationsService.vehiculeVerification(informations);
        reservationsService.requestYearClient(client.getBirthday(), vehicle.getHorsePower());
        reservationsService.verifMaintenance(vehicle.getId());
        reservationsService.verificationVehiculeReservation(vehicle, informations, reservationsDao);
